  ...
  subTreatments: [
    {
      ...
      faqs: [
        { _key: key(), q: "How can I find out if an implant is right for me?", a: "We offer a 30-minute consultation for new implant patients, which includes a 3D scan using our in-house machine. Dr Nick will personally look at your foundations, talk through your goals, and let you know whether a dental implant is a suitable option for your smile." },
        ...
        { _key: key(), q: "Are there payment plans available?", a: "Yes. We believe quality care should be accessible. We offer flexible payment plans through our trusted financing partners, TLC Finance. This allows you to break down the cost of your treatment into manageable weekly instalments, from around $50 per week." },
      ],
    },
    {
      _key: key(),
      ...
      faqs: [
        ...
        { _key: key(), q: "Do you offer flexible dental payment options?", a: "Absolutely. We believe that choosing bio-inert dental care should fit comfortably within your family budget. We offer interest-free dental payment plans that allow you to distribute the cost of your ceramic implant into structured weekly or monthly instalments over your active healing period." },
      ],
    },
    {
      _key: key(),
  ...
  subTreatments: [
    {
      ...
      whatToExpect: ["90 minutes to 2 hours total in the chair", "Local anaesthetic throughout", "Ceramic milled while you wait (~20 minutes)", "Shade-matched to your neighbouring teeth", "Bonded same day — no temporary needed"],
      processSteps: [
    ...
    },
    {
      ...
      whatToExpect: ["Digital smile design preview before any tooth is touched", "Shade-matched to your whitening result (if applicable)", "Milled and bonded same day", "High-strength ceramic — no metal", "From ~$1,600 per tooth; weekly payment options"],
      ...
      beforeAfter: [
        { _key: key(), before: "https://res.cloudinary.com/dzydzte9h/image/upload/q_auto,f_auto/dental-website/same-day-smile/cerec-crowns-veneers/before-and-after/case-1-before.jpg", after: "https://res.cloudinary.com/dzydzte9h/image/upload/q_auto,f_auto/dental-website/same-day-smile/cerec-crowns-veneers/before-and-after/case-1-after.jpg", caption: "Emax ceramic veneers for a durable, natural smile makeover. The after photo was taken at a 10-year follow-up appointment." },
        { _key: key(), before: "https://res.cloudinary.com/dzydzte9h/image/upload/q_auto,f_auto/dental-website/same-day-smile/cerec-crowns-veneers/before-and-after/case-2-before.jpg", after: "https://res.cloudinary.com/dzydzte9h/image/upload/q_auto,f_auto/dental-website/same-day-smile/cerec-crowns-veneers/before-and-after/case-2-after.jpg", caption: "Ceramic veneers; the after photo was taken at a 10-year review appointment." },
        ...
        { _key: key(), before: "https://res.cloudinary.com/dzydzte9h/image/upload/q_auto,f_auto/dental-website/same-day-smile/cerec-crowns-veneers/before-and-after/case-5-before.jpg", after: "https://res.cloudinary.com/dzydzte9h/image/upload/q_auto,f_auto/dental-website/same-day-smile/cerec-crowns-veneers/before-and-after/case-5-after.jpg", caption: "A 60th birthday present — delivered in one day with Emax veneers." },
        { _key: key(), before: "https://res.cloudinary.com/dzydzte9h/image/upload/q_auto,f_auto/dental-website/same-day-smile/cerec-crowns-veneers/before-and-after/case-6-before.jpg", after: "https://res.cloudinary.com/dzydzte9h/image/upload/q_auto,f_auto/dental-website/same-day-smile/cerec-crowns-veneers/before-and-after/case-6-after.jpg", caption: "A retirement gift to self — a veneer smile makeover with Emax ceramic." },
    ...
    },
    {
      ...
      whatToExpect: ["Conservative Tooth Preparation: we remove only the decayed part, keeping most of your healthy natural enamel", "No \"Putty\" Impressions: a digital 3D scanner — faster, more comfortable, and more accurate than traditional moulds", "Precise Bite Alignment: designed to the micron so your bite feels well balanced", "Strong and Durable: high-strength Ivoclar e.max — resists shrinking, leaking, and staining, providing a durable seal that helps protect against future decay", "Bonded in a single 90-minute visit — no temporary, no second appointment"],
      pricing: [
      ...
      processSteps: [
        ...
        { _key: key(), title: "Custom Design", description: "Design your restoration on screen to match your bite." },
      ...
      faqs: [
        ...
        { _key: key(), q: "Why do you use Ivoclar e.max?", a: "Ivoclar e.max® is one of the most widely used and well-documented glass-ceramics. It has high strength to withstand the heavy biting forces of back teeth, and its natural aesthetics mimic the translucency and light-reflection of real tooth enamel so the restoration blends closely with your own teeth once bonded. We mill it in-house with CEREC." },
    ...
    },
    {
      ...
      faqs: [
        ...
        { _key: key(), q: "How do I get started?", a: "Should you wish to explore a meaningful yet cost-conscious enhancement, we welcome you to schedule a 30-minute assessment to determine whether dental bonding or composite veneering is a suitable option for your needs." },
      ],
    },
  ],
  processSteps: [
  ...
  subTreatments: [
    {
      ...
      whatToExpect: ["Discreet: the clear aligners are difficult to notice during everyday wear", "Completely Removable: take your aligners out to eat, drink, brush, and floss normally, making it easier to maintain excellent oral hygiene", "Comfort: custom-moulded from smooth medical-grade plastic, which avoids the lip and cheek irritation that metal wires and brackets can cause", "Worn around 22 hours per day; reviews every 6–8 weeks with Dr. Jimmy", "Refinement aligners and retainers included; typically 6–18 months for adults"],
      pricing: [
