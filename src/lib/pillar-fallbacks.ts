  ...
  subTreatments: [
    ...
    },
    {
      ...
      faqs: [
        ...
        { q: "Why do you use Ivoclar e.max?", a: "Ivoclar e.max® is one of the most widely used and well-documented glass-ceramics. It has high strength to withstand the heavy biting forces of back teeth, and its natural aesthetics mimic real enamel so the restoration blends closely with your own teeth once bonded. We mill it in-house with CEREC." },
      ...
      faqs: [
        {
          ...
          a: "We offer a 30-minute consultation for new implant patients, which includes a 3D scan using our in-house machine. Dr Nick will personally look at your foundations, talk through your goals, and let you know whether a dental implant is a suitable option for your smile.",
        },
        {
